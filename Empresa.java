...
public class Empresa {
    ...
    public static void main(String[] args) {
        Empresa minhaEmpresa = new Empresa("MarcosVende", "887765924");

        minhaEmpresa.contratarFuncionario("Marcos");
        minhaEmpresa.contratarFuncionario("Vinicius");

        minhaEmpresa.exibirInformacoesFuncionarios();

        minhaEmpresa.demitirFuncionario("Marcos");
